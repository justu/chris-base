...
import com.chris.base.modules.sys.dao.SysUserTokenDao;
import com.chris.base.modules.sys.entity.SysUserTokenEntity;
import com.chris.base.modules.sys.oauth2.TokenGenerator;
...
public class SysUserTokenServiceImpl implements SysUserTokenService {
	...
	@Override
	public CommonResponse createToken(long userId) {
		//生成一个token
		...
		return CommonResponse.ok().put("token", token).put("expire", EXPIRE);
	}
